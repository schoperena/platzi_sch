from borracho import BorrachoTradiconal
...
def simular_caminata(pasos, numero_de_intentos, tipo_de_borracho):
    borracho = tipo_de_borracho(nombre='Puto')
...
if __name__ == "__main__":
    distancias_de_caminata = [10, 100, 1000, 10000, 10000]
    numero_de_intentos = 100

    main(distancias_de_caminata, numero_de_intentos, BorrachoTradiconal)
